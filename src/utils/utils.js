...
export const FANTOM_DNSREGISTRAR_ADDRESS =
  '0xC000f5161A12f0a300B2c7FB6F562a6226C0DDa6'
...
export const aboutPageURL = () => {
  ...
  return `https://fantomdomains.io/${lang === 'en' ? '' : lang}`
}
...
export function imageUrl(url, name, network) {
  ...
  if (_protocol && _network && name) {
    return `https://metadata.fantomdomains.io/${_network}/avatar/${name}`
  }
