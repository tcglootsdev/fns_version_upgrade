...
const Section1 = ({ question, children }) => {
  let slug
  if (question) {
    slug = slugify(question, {
      lower: true
  ...
  return (
    <>
      ...
      <FaqContainer>
        ...
        <Section question="Is FNS only for storing an Fantom address?">
        No, you can store the addresses of over 100 blockchains, a content hash of 
        a decentralized website, profile information such as an avatar and Twitter handle, and more.
        </Section>
         ...
         tools and applications which resolve IP addresses attached to FNS.
          ...
          Instead, we suggest hosting your static html/css/images on IPFS and put
           ...
           FNS-aware browsers (e.g. Opera), browser extensions (Metamask), or any
            browser with ".link" or ".limo" appended to the end 
            (e.g. matoken.ftm.link or matoken.ftm.limo).
          <br />
          If you want to redirect your FNS name to an existing website, you could 
          write a html file containing JavaScript logic to redirect to your website, 
          upload the file into ipfs using services like {' '}
          <a href="https://pinata.cloud/">IPFS Pinata</a>, then set the CID to your 
          contenthash. See the source code of depositcontract.ftm.link as an example.
        </Section>
        ...
        <Section1 question="How much does it cost to register a .ftm name?">
          Currently, registration costs are set at the following prices:
          <ul>
            <li>5+ character .ftm names: $25 in FTM per year.</li>
            <li>4 character .ftm names: $50 in FTM per year.</li>
            <li>3 character .ftm names $210 in FTM per year.</li>
          </ul>
        ...
        <Section question="How much gas does it cost to register and extend registration?">
          ...
          (register, set resolver and set ftm address) hence the gas cost is
          relatively expensive.
        </Section>

        <Section question="Can I register names other than .ftm?">
          Yes, you can import into FNS any DNS name with the required DNSSEC.
          <br />
          Please refer to our{' '}
          <a href="https://fantomdomains.io/">guide</a> for
          more detail.
        </Section>
        ...
        <Section question="I am stuck at step 2">
          ...
          make sure that the Fantom blockchain has progressed. If this
        ...
        <Section question="I cannot see the names I registered on PaintSwap nor on my wallet">
          This occasionally happens when PaintSwap is under a heavy load. You may
          also not find your name under the NFT section of your wallet, as many
          wallets fetch metadata from PaintSwap.
          <br />
          As long as you can see your registered name under "My Account" on our
          site or your FTM address under the name section, your name is
        ...
        <Section question="What is the difference between the Registrant and Controller?">
          ...
          resolver and add/edit records. Some dapps (eg: PaintSwap) set
        ...
        <Section question="What is a Primary FNS Name record?">
          A Primary FNS Name record (formerly Reverse Record) makes your
          Fantom address point to an FNS name. This allows dapps to find and
          display your FNS name when you connect to them with your Fantom
          account. This can only be set by you so it is not set automatically
          upon registration.
          <br />
          To set the Primary FNS Name record, please click "My account", and
          select "Primary FNS Name".
        </Section>
        ...
        <Section question="How do I unregister my name?">
          ...
          you cannot do so on ".ftm" addresses. Because ‘.ftm` names are
        ...
        <Section question="How do I transfer my name?">
          ...
          the new Fantom account. Since ".ftm" names are ERC721 compliant
          ...
          names, it may be a good idea for you to set the FTM Address record to
          their Fantom address, set the controller, then transfer the name.
          <br />
        ...
        <Section question="What happens if I forget to extend the registration of a name?">
          ...
          released name continues to resolve your FTM address until the new
          owner overwrites it.
        </Section>

        <Section question="I lost access to the Fantom account that owns a name I registered. Can I still extend its registration period?">
          Any Fantom account can pay to extend the registration of any FNS
